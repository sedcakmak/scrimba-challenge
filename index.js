...
function renderBtns(){
  ...
  actionsArr.forEach(action => {
    ...
    buttonElement.textContent = action.emoji + " " + action.text;
    action.good ? buttonElement.classList.add("btn-good") : buttonElement.classList.add("btn-bad");
 ...
 function updatePoints(e) {
  ...
  //  Change Background Color
   ...
   function changeBackgroundColor(e) {
      const colors = ["#ff160c", "#f44800", "#e96200", "#dd7600", "#d18600", "#c69300","#bb9f1e", "#b1aa38", "#a9b34f",  "#a3ba66", "#a0c17c", "#9fc791", "#a3cda5", "#aad1b6","#a2d6b0","#9adaaa","#93dea3","#8ce29b","#85e692","#7fea88","#7aed7e","#75f072","#70f466", "#6df757", "#6afa46", "#67fc30", "#66ff00"]
